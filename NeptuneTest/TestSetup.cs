...
namespace com.gt.NeptuneTest
{
    ...
    public class TestSetup : SimpleWorker, ISettingDefinitionSource
    {
        ...
        static internal ISettingDefinition PoiDbNetworkAddress = new SimpleSettingDefinition("PoiDbNetworkAddress", "NeptuneTest", "Network address of Postgres Container");
    ...
    public class TestTeardown : SimpleWorker
    {
        ...
        TestSetup.DockerExe.FullKey(), TestSetup.PoiDbNetworkAddress.FullKey() })
        { }
